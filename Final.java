...
public class Final {
	...
	public static void main(String[] args) throws InterruptedException, IOException  {
		...
		System.setProperty("webdriver.chrome.driver", "D:\\Mahima\\Selenium jar\\Web driver\\chromedriver.exe");
		...
		Files.copy(src, new File("D:\\Mahima\\Screenshot\\home1.png"));
	 ...
	 //--------------------------------------------------------------------------------------------------------------
	        ...
	        //take screenshot after submit
	         TakesScreenshot t5=(TakesScreenshot) w;
	  		 ...
	  		 Files.copy(src5, new File("D:\\Mahima\\Screenshot\\get_submit.png"));
	  		 w.navigate().back();
	  		 Thread.sleep(3000);
	  		 w.navigate().back();
	         ...
	         w.switchTo().window(parent_window5);
	  		 ...
	  		 Files.copy(src6, new File("D:\\Mahima\\Screenshot\\vegan.png"));
	...
	//--------------------------------------------------------------------------------------------------------------------------------------------------  			
	  			...
	  			//TC05	     
	  				     ...
	  				     w.findElement(By.xpath("//*[@id=\"contact_form\"]/div[4]/input")).click();
	  				       ...
	  				       Files.copy(src7, new File ("D:\\Mahima\\Screenshot\\Fi1.png"));
